...
public class Cliente extends Usuario{
    ...
    public Cliente(Long id, String nome, String email, String senha, Perfil perfil, Boolean habilitado, Endereco endereco, String telefone, String cpf, LocalDate dataNascimento) {
